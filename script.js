    ...
    screen.innerHTML = `
      <div class="welcome">
        ...
        <div class="founders-card">
          <div class="founders-img-wrapper">
            <img src="assets/founders.jpg" alt="Fundadores del Método Lash Mastery" class="founders-img" onerror="this.parentElement.classList.add('is-fallback'); this.style.display='none';" />
            <div class="founders-fallback" aria-hidden="true">LM</div>
          </div>
          <div class="founders-caption">Presentado por los fundadores</div>
        </div>
